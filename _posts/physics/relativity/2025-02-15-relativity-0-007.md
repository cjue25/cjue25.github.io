...
$$
(P_\text{spatial} c)^2 = \frac{m^2u^2c^2}{1-\frac{u^2}{c^2}}\\
E^2 = \frac{m^2c^4}{1-\frac{u^2}{c^2}}\\
E^2 - (P_\text{spatial} c)^2 = \frac{m^2c^4 - m^2u^2c^2}{1-\frac{u^2}{c^2}}
= \frac{m^2c^4(1 - \frac{u^2}{c^2})}{1-\frac{u^2}{c^2}}
= m^2c^4\\
\Rightarrow E^2 - (pc)^2 = (mc^2)^2 \Rightarrow E^2 = (pc)^2 + (mc^2)^2
$$
